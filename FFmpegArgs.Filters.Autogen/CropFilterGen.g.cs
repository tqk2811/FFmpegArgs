...
/// </summary>
public CropFilterGen keep_aspect(bool flag) => this.SetOption("keep_aspect",flag.ToFFmpegFlag());
/// <summary>
///  do exact cropping (default false)
/// </summary>
public CropFilterGen exact(bool flag) => this.SetOption("exact",flag.ToFFmpegFlag());
}
