...
{
internal Pal75barsFilterGen(IFilterGraph input) : base("pal75bars",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static Pal75barsFilterGen Pal75barsFilterGen(this IFilterGraph input0) => new Pal75barsFilterGen(input0);
}
}
