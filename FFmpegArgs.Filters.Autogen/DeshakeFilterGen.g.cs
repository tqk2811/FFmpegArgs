...
if(config?.rx != null) result.rx(config.rx);
if(config?.ry != null) result.ry(config.ry);
if(config?.edge != null) result.edge(config.edge);
if(config?.blocksize != null) result.blocksize(config.blocksize);
if(config?.contrast != null) result.contrast(config.contrast);
if(config?.search != null) result.search(config.search);
