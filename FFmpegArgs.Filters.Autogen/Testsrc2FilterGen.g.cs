...
{
internal Testsrc2FilterGen(IFilterGraph input) : base("testsrc2",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static Testsrc2FilterGen Testsrc2FilterGen(this IFilterGraph input0) => new Testsrc2FilterGen(input0);
}
}
