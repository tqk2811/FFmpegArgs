...
{
internal ColorspectrumFilterGen(BaseFilterGraph input) : base("colorspectrum",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static ColorspectrumFilterGen ColorspectrumFilterGen(this BaseFilterGraph input0) => new ColorspectrumFilterGen(input0);
}
/// <summary>
///  set the color spectrum type (from 0 to 2) (default black)
/// </summary>
