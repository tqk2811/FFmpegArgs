...
{
internal CellautoFilterGen(BaseFilterGraph input) : base("cellauto",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static CellautoFilterGen CellautoFilterGen(this BaseFilterGraph input0) => new CellautoFilterGen(input0);
}
}
