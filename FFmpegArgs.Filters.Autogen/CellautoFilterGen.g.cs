...
{
internal CellautoFilterGen(IFilterGraph input) : base("cellauto",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static CellautoFilterGen CellautoFilterGen(this IFilterGraph input0) => new CellautoFilterGen(input0);
}
}
