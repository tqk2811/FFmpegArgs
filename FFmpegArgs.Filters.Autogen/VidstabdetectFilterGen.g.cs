...
if(config?.result != null) result.result(config.result);
if(config?.shakiness != null) result.shakiness(config.shakiness);
if(config?.accuracy != null) result.accuracy(config.accuracy);
if(config?.stepsize != null) result.stepsize(config.stepsize);
if(config?.mincontrast != null) result.mincontrast(config.mincontrast);
