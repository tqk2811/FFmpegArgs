...
if(config?.s0 != null) result.s0(config.s0);
if(config?.s1 != null) result.s1(config.s1);
if(config?.s2 != null) result.s2(config.s2);
if(config?.s3 != null) result.s3(config.s3);
if(config?.d0 != null) result.d0(config.d0);
