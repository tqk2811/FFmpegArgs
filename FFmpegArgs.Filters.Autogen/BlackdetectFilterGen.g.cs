...
if(config?.black_min_duration != null) result.black_min_duration(config.black_min_duration);
if(config?.picture_black_ratio_th != null) result.picture_black_ratio_th(config.picture_black_ratio_th);
if(config?.pic_th != null) result.pic_th(config.pic_th);
if(config?.pixel_black_th != null) result.pixel_black_th(config.pixel_black_th);
if(config?.pix_th != null) result.pix_th(config.pix_th);
return result;
}
}
