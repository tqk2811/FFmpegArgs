...
{
internal Frei0r_srcFilterGen(BaseFilterGraph input) : base("frei0r_src",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static Frei0r_srcFilterGen Frei0r_srcFilterGen(this BaseFilterGraph input0) => new Frei0r_srcFilterGen(input0);
}
}
