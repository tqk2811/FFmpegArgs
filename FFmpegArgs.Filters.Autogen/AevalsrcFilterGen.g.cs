...
{
internal AevalsrcFilterGen(BaseFilterGraph input) : base("aevalsrc",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static AevalsrcFilterGen AevalsrcFilterGen(this BaseFilterGraph input0) => new AevalsrcFilterGen(input0);
}
}
