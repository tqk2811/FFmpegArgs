...
{
internal AevalsrcFilterGen(IFilterGraph input) : base("aevalsrc",input) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static AevalsrcFilterGen AevalsrcFilterGen(this IFilterGraph input0) => new AevalsrcFilterGen(input0);
}
}
