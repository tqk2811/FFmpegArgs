namespace FFmpegArgs.Filters
{
    ...
    public abstract class AudioToAudioFilter : BaseFilter<AudioMap, AudioMap>
    {
        ...
        /// 
        /// </summary>
        protected void AddMapOut() => _mapsOut.Add(new AudioMap(FilterGraph, $"f_{FilterIndex}"));

        /// <summary>
        /// 
        /// </summary>
        /// <param name="index"></param>
        protected void AddMapOut(int index) => _mapsOut.Add(new AudioMap(FilterGraph, $"f_{FilterIndex}_{index}"));
