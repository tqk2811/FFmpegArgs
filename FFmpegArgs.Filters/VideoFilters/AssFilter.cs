...
namespace FFmpegArgs.Filters.VideoFilters
{
    ...
    {
        internal AssFilter(string fileName, ImageMap imageMap) : base(fileName, "ass", imageMap)
        {
    ...
    public static class AssFilterExtensions
    {
        ...
        /// <returns></returns>
        public static AssFilter AssFilter(this ImageMap imageMap, string fileName)
          => new AssFilter(fileName, imageMap);
    }
