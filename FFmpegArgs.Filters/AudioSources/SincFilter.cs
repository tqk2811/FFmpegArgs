...
namespace FFmpegArgs.Filters.AudioSources
{
    ...
    /// </summary>
    public class SincFilter : SourceToAudioFilter
    {
        internal SincFilter(IAudioFilterGraph filterGraph) : base("sinc", filterGraph)
        {
            AddMapOut();
        }
        /// <summary>
    ...
    public static class SincFilterExtensions
    {
        ...
        /// <returns></returns>
        public static SincFilter SincFilter(this IAudioFilterGraph filterGraph)
