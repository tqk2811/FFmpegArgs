namespace FFmpegArgs.Filters.VideoSources
{
    ...
    {
        internal GradientsFilter(BaseFilterGraph filterGraph) : base("gradients", filterGraph)
        {
            AddMapOut();
        }
        /// <summary>
    ...
    public static class GradientsFilterExtensions
    {
        ...
        /// <returns></returns>
        public static GradientsFilter GradientsFilter(this BaseFilterGraph filterGraph)
