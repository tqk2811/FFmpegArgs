...
{
    /// <summary>
    /// TSC bass              A->A       Boost or cut lower frequencies.<br></br>
    /// <see href="https://ffmpeg.org/ffmpeg-filters.html#bass_002c-lowshelf"/>
    /// </summary>
    public class BassFilter : AudioToAudioFilter, ITimelineSupport, ISliceThreading, ICommandSupport,
        IPrecision,ITransform, IChannels, INormalize, IWidthType
    {
        internal BassFilter(AudioMap audioMap) : base("bass", audioMap)
        {
            AddMapOut();
        }
        /// <summary>
        ...
        /// <returns></returns>
        public BassFilter Frequency(double frequency)
        ...
        /// <returns></returns>
        public BassFilter Width(double width)
        ...
        /// <returns></returns>
        public BassFilter Gain(double gain)
        ...
        /// <returns></returns>
        public BassFilter Poles(int poles)
        ...
        /// <returns></returns>
        public BassFilter Mix(double mix)
           => this.SetOptionRange("m", mix, 0, 1);
    }
    /// <summary>
    /// 
    /// </summary>
    public static class BassFilterExtensions
    {
        /// <summary>
        ...
        /// <br></br><see href="https://ffmpeg.org/ffmpeg-filters.html#bass_002c-lowshelf"/>
        /// </summary>
        public static BassFilter BassFilter(this AudioMap audioMap)
          => new BassFilter(audioMap);
    }
