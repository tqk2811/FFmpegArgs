...
namespace FFmpegArgs.Filters.AudioFilters
{
    ...
    /// <see href="https://ffmpeg.org/ffmpeg-filters.html#compensationdelay"/>
    /// </summary>
    ...
    public static class CompensationdelayFilterExtensions
    {
        ...
        /// </br>The best result can be reached when you take one track as base and synchronize other tracks one by one with it.Remember that synchronization / delay tolerance depends on sample rate, too.Higher sample rates will give more tolerance.<br>
        /// </br><see href="https://ffmpeg.org/ffmpeg-filters.html#compensationdelay"/>
        /// </summary>
