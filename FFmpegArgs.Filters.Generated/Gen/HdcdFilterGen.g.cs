namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal HdcdFilterGen(AudioMap input) : base("hdcd", input)
        {
            AddMapOut();
        }
    ...
    public enum HdcdFilterGenAnalyze_mode
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("lle")]
        lle = 1,
        /// <summary>
        /// pe              2            ..F.A...... samples where peak extend occurs
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("pe")]
        pe = 2,
        /// <summary>
        /// cdt             3            ..F.A...... samples where the code detect timer is active
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("cdt")]
        cdt = 3,
        /// <summary>
        /// tgm             4            ..F.A...... samples where the target gain does not match between channels
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("tgm")]
        tgm = 4
    }
    ...
    public enum HdcdFilterGenBits_per_sample
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("16")]
        _16 = 16,
        /// <summary>
        /// 20              20           ..F.A...... 20-bit (in s32)
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("20")]
        _20 = 20,
        /// <summary>
        /// 24              24           ..F.A...... 24-bit (in s32)
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("24")]
        _24 = 24
    }
