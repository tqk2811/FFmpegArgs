...
{
internal Bm3dFilterGen(params ImageMap[] inputs) : base("bm3d",inputs) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static Bm3dFilterGen Bm3dFilterGen(this IEnumerable<ImageMap> inputs) => new Bm3dFilterGen(inputs.ToArray());
}
/// <summary>
///  set filtering estimation mode (from 0 to 1) (default basic)
/// </summary>
