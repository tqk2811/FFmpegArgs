namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal VidstabtransformFilterGen(ImageMap input) : base("vidstabtransform", input)
        {
            AddMapOut();
        }
    ...
    public enum VidstabtransformFilterGenOptalgo
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("opt")]
        opt = 0,
        /// <summary>
    ...
    public enum VidstabtransformFilterGenCrop
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("keep")]
        keep = 0,
        /// <summary>
    ...
    public enum VidstabtransformFilterGenInterpol
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("no")]
        no = 0,
        /// <summary>
