...
{
internal Ebur128FilterGen(int outputCount, AudioMap input) : base("ebur128",input) { AddMultiMapOut(outputCount); }
/// <summary>
...
/// EBU R128 scanner.
/// </summary>
public static Ebur128FilterGen Ebur128FilterGen(this AudioMap input0, int outputCount) => new Ebur128FilterGen(outputCount, input0);
}
/// <summary>
///  force frame logging level (from INT_MIN to INT_MAX) (default -1)
/// </summary>
