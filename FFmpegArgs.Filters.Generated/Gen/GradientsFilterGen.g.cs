namespace FFmpegArgs.Filters.Generated
{
    ...
    public class GradientsFilterGen : SourceToImageFilter, ISliceThreading
    {
        ...
        /// </summary>
        public GradientsFilterGen size(Size size) => this.SetOption("size", Inv($"{size.Width}x{size.Height}"));
        /// <summary>
    ...
    public enum GradientsFilterGenType
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("circular")]
        circular = 2,
        /// <summary>
        /// spiral          3            ..FV.....T. set spiral gradient
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("spiral")]
        spiral = 3,
        /// <summary>
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// Draw a gradients.
        /// </summary>
        public static GradientsFilterGen GradientsFilterGen(this IImageFilterGraph input) => new GradientsFilterGen(input);
    }
}