namespace FFmpegArgs.Filters.Generated
{
    ...
    public class Xstack_vaapiFilterGen : ImageToImageFilter
    {
        ...
        /// </summary>
        public Xstack_vaapiFilterGen grid(Size grid) => this.SetOption("grid", Inv($"{grid.Width}x{grid.Height}"));
        /// <summary>
        ///  set tile size in grid layout
        /// </summary>
        public Xstack_vaapiFilterGen grid_tile_size(Size grid_tile_size) => this.SetOption("grid_tile_size", Inv($"{grid_tile_size.Width}x{grid_tile_size.Height}"));
        /// <summary>
