...
{
internal Xstack_vaapiFilterGen(params ImageMap[] inputs) : base("xstack_vaapi",inputs) { AddMapOut(); }
/// <summary>
...
///  Set custom layout
/// </summary>
public Xstack_vaapiFilterGen layout(string layout) => this.SetOption("layout",layout);
/// <summary>
