...
{
internal LimitdiffFilterGen(params ImageMap[] inputs) : base("limitdiff",inputs) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static LimitdiffFilterGen LimitdiffFilterGen(this IEnumerable<ImageMap> inputs) => new LimitdiffFilterGen(inputs.ToArray());
}
}
