namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal CodecviewFilterGen(ImageMap input) : base("codecview", input)
        {
            AddMapOut();
        }
    ...
    public enum CodecviewFilterGenMv
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("pf")]
        pf,
        /// <summary>
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("bb")]
        bb
    }
    ...
    public enum CodecviewFilterGenMv_type
    {
        ...
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("fp")]
        fp,
        /// <summary>
        /// bp                           ..FV....... backward predicted MVs
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("bp")]
        bp
    }
    ...
    public enum CodecviewFilterGenFrame_type
    {
        ...
        /// if                           ..FV....... I-frames
        /// </summary>
        [FFmpegArgs.Cores.Attributes.NameAttribute("if")]
        _if,
        /// <summary>
        /// pf                           ..FV....... P-frames
        /// </summary>
