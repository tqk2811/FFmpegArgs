namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal DecimateFilterGen(params ImageMap[] inputs) : base("decimate", inputs)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static DecimateFilterGen DecimateFilterGen(this ImageMap input) => new DecimateFilterGen(input);
    }
}