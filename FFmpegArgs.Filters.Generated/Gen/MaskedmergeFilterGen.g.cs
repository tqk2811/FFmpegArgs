namespace FFmpegArgs.Filters.Generated
{
    ...
    /// </summary>
    public class MaskedmergeFilterGen : ImageToImageFilter, ITimelineSupport, ISliceThreading
    {
        internal MaskedmergeFilterGen(params ImageMap[] inputs) : base("maskedmerge", inputs)
        {
            AddMapOut();
        }
