namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal AbufferFilterGen(IAudioFilterGraph input) : base("abuffer", input)
        {
            AddMapOut();
        }
        ...
        /// 
        /// </summary>
        public AbufferFilterGen channel_layout(ChannelLayout channel_layout) => this.SetOption("channel_layout", channel_layout.GetEnumAttribute<NameAttribute>().Name);
        /// <summary>
        ///  (from 0 to INT_MAX) (default 0)
        /// </summary>
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static AbufferFilterGen AbufferFilterGen(this IAudioFilterGraph input) => new AbufferFilterGen(input);
    }
}