...
{
internal SignatureFilterGen(params ImageMap[] inputs) : base("signature",inputs) { AddMapOut(); }
/// <summary>
...
/// </summary>
public static SignatureFilterGen SignatureFilterGen(this IEnumerable<ImageMap> inputs) => new SignatureFilterGen(inputs.ToArray());
}
/// <summary>
///  set the detectmode (from 0 to 2) (default off)
/// </summary>
