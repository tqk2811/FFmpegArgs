namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal AnullsrcFilterGen(IAudioFilterGraph input) : base("anullsrc", input)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static AnullsrcFilterGen AnullsrcFilterGen(this IAudioFilterGraph input) => new AnullsrcFilterGen(input);
    }
}