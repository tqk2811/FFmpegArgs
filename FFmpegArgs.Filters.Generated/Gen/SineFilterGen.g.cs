namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal SineFilterGen(IAudioFilterGraph input) : base("sine", input)
        {
            AddMapOut();
        }
        ...
        /// </summary>
        public SineFilterGen samples_per_frame(String samples_per_frame) => this.SetOption("samples_per_frame", samples_per_frame.ToStringInv());
    }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static SineFilterGen SineFilterGen(this IAudioFilterGraph input) => new SineFilterGen(input);
    }
}