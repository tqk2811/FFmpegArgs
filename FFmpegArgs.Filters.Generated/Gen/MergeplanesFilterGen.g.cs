namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal MergeplanesFilterGen(params ImageMap[] inputs) : base("mergeplanes", inputs)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// Merge planes.
        /// </summary>
        public static MergeplanesFilterGen MergeplanesFilterGen(this ImageMap input) => new MergeplanesFilterGen(input);
    }
}