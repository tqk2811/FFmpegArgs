...
{
internal XstackFilterGen(params ImageMap[] inputs) : base("xstack",inputs) { AddMapOut(); }
/// <summary>
...
///  set custom layout
/// </summary>
public XstackFilterGen layout(string layout) => this.SetOption("layout",layout);
/// <summary>
...
/// </summary>
public static XstackFilterGen XstackFilterGen(this IEnumerable<ImageMap> inputs) => new XstackFilterGen(inputs.ToArray());
}
}
