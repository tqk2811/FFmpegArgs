namespace FFmpegArgs.Filters.Generated
{
    ...
    public class AvsynctestFilterGen : SourceToAudioFilter
    {
        ...
        /// </summary>
        public AvsynctestFilterGen size(Size size) => this.SetOption("size", Inv($"{size.Width}x{size.Height}"));
        /// <summary>
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static AvsynctestFilterGen AvsynctestFilterGen(this IAudioFilterGraph input) => new AvsynctestFilterGen(input);
    }
}