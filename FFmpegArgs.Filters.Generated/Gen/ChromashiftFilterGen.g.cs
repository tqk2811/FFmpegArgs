namespace FFmpegArgs.Filters.Generated
{
    ...
    /// </summary>
    public class ChromashiftFilterGen : ImageToImageFilter, ITimelineSupport, ISliceThreading
    {
        internal ChromashiftFilterGen(ImageMap input) : base("chromashift", input)
        {
            AddMapOut();
        }
