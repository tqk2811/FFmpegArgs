namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal SincFilterGen(IAudioFilterGraph input) : base("sinc", input)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static SincFilterGen SincFilterGen(this IAudioFilterGraph input) => new SincFilterGen(input);
    }
}