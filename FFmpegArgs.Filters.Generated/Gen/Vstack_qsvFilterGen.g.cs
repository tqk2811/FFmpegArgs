namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal Vstack_qsvFilterGen(params ImageMap[] inputs) : base("vstack_qsv", inputs)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static Vstack_qsvFilterGen Vstack_qsvFilterGen(this ImageMap input) => new Vstack_qsvFilterGen(input);
    }
}