namespace FFmpegArgs.Filters.Generated
{
    ...
    public class Pad_openclFilterGen : ImageToImageFilter
    {
        ...
        /// </summary>
        public Pad_openclFilterGen width(String width) => this.SetOption("width", width.ToString());
        /// <summary>
        ///  set the pad area height (default &quot;ih&quot;)
        /// </summary>
        public Pad_openclFilterGen height(String height) => this.SetOption("height", height.ToString());
        /// <summary>
        ///  set the x offset for the input image position (default &quot;0&quot;)
        /// </summary>
        public Pad_openclFilterGen x(String x) => this.SetOption("x", x.ToString());
        /// <summary>
        ///  set the y offset for the input image position (default &quot;0&quot;)
        /// </summary>
        public Pad_openclFilterGen y(String y) => this.SetOption("y", y.ToString());
        /// <summary>
