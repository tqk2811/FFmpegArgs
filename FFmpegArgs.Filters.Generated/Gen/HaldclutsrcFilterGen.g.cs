namespace FFmpegArgs.Filters.Generated
{
    ...
    {
        internal HaldclutsrcFilterGen(IImageFilterGraph input) : base("haldclutsrc", input)
        {
            AddMapOut();
        }
    ...
    public static partial class FilterGeneratedExtensions
    {
        ...
        /// </summary>
        public static HaldclutsrcFilterGen HaldclutsrcFilterGen(this IImageFilterGraph input) => new HaldclutsrcFilterGen(input);
    }
}