namespace FFmpegArgs.Filters.Generated
{
    ...
    /// </summary>
    public class ColorcontrastFilterGen : ImageToImageFilter, ITimelineSupport, ISliceThreading
    {
        internal ColorcontrastFilterGen(ImageMap input) : base("colorcontrast", input)
        {
            AddMapOut();
        }
