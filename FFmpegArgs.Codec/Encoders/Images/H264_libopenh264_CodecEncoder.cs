...
namespace FFmpegArgs.Codec.Encoders.Images
{
    ...
    /// 
    /// </summary>
    public class H264_libopenh264_CodecEncoder : BaseImageCodecEncoder
    {
        /// <summary>
        /// 
        /// </summary>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
    ...
    public static partial class ImageEncoderExtensions
    {
        ...
        public static T H264_libopenh264_Codec<T>(this T stream, Action<H264_libopenh264_CodecEncoder> action) where T : ImageOutputAVStream
        {
            action.Invoke(stream.H264_libopenh264_Codec());
            return stream;
        }
    }
}
