namespace FFmpegArgs
{
    ...
    public static class AudioCodecOptionsExtension
    {
        ...
        /// <returns></returns>
        public static T B<T>(this T t, int bitrate) where T : OutputAVStream, IAudio//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Maxrate<T>(this T t, int maxrate) where T : OutputAVStream, IAudio//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Minrate<T>(this T t, int minrate) where T : OutputAVStream, IAudio//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Bufsize<T>(this T t, int bufsize) where T : OutputAVStream, IAudio//encoding,audio,video
        ...
        /// <param name="hz"></param>
        /// <returns></returns>
        public static T Ar<T>(this T t, int hz) where T : BaseAVStream, IAudio//decoding/encoding,audio
        ...
        /// <param name="ac"></param>
        /// <returns></returns>
        public static T Ac<T>(this T t, int ac) where T : BaseAVStream, IAudio//decoding/encoding,audio
        ...
        /// <returns></returns>
        public static T CutOff<T>(this T t, int cutoff) where T : OutputAVStream, IAudio//encoding,audio
        ...
        /// <returns></returns>
        public static T FrameSize<T>(this T t, int frame_size) where T : OutputAVStream, IAudio//encoding,audio
