namespace FFmpegArgs
{
    ...
    public static class ImageCodecOptionsExtension
    {
        ...
        /// <returns></returns>
        public static T B<T>(this T t, long bitrate) where T : OutputAVStream, ICodec, ICodecEncoder, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Maxrate<T>(this T t, long maxrate) where T : OutputAVStream, ICodec, ICodecEncoder, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Minrate<T>(this T t, long minrate) where T : OutputAVStream, ICodec, ICodecEncoder, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Bufsize<T>(this T t, long bufsize) where T : OutputAVStream, ICodec, ICodecEncoder, IImage//encoding,audio,video
