namespace FFmpegArgs
{
    ...
    public static class ImageCodecOptionsExtension
    {
        ...
        /// <returns></returns>
        public static T B<T>(this T t, int bitrate) where T : OutputAVStream, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Maxrate<T>(this T t, int maxrate) where T : OutputAVStream, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Minrate<T>(this T t, int minrate) where T : OutputAVStream, IImage//encoding,audio,video
        ...
        /// <returns></returns>
        public static T Bufsize<T>(this T t, int bufsize) where T : OutputAVStream, IImage//encoding,audio,video
        ...
        /// <param name="g"></param>
        /// <returns></returns>
        public static T G<T>(this T t, int g) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T Qcomp<T>(this T t, float qcomp) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <param name="qcomp"></param>
        /// <returns></returns>
        public static T Qblur<T>(this T t, float qcomp) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T Qmin<T>(this T t, int qmin) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T Qmax<T>(this T t, int qmax) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T Qdiff<T>(this T t, int qdiff) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <param name="bf"></param>
        /// <returns></returns>
        public static T Bf<T>(this T t, int bf) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T BQfactor<T>(this T t, float b_qfactor) where T : OutputAVStream, IImage//encoding,video
        ...
        /// <returns></returns>
        public static T BQoffset<T>(this T t, float b_qoffset) where T : OutputAVStream, IImage//encoding,video
