namespace FFmpegArgs
{
    ...
    public static class CodecOptionsExtension
    {
        ...
        internal static T Maxrate<T>(this T t, int maxrate) where T : OutputAVStream, ICodec, ICodecEncoder//encoding,audio,video
