...
namespace FFmpegArgs.Filters.VideoFilters
{
    ...
    public class SubtitleStyleConfig
    {
        ...
        public override string ToString()
        {
            ...
            if (ScaleX != null) pairs[nameof(ScaleX)] = ScaleX.Value.ToString(BaseOption.DefaultCultureInfo);
            if (ScaleY != null) pairs[nameof(ScaleY)] = ScaleY.Value.ToString(BaseOption.DefaultCultureInfo);
            if (Spacing != null) pairs[nameof(Spacing)] = Spacing.Value.ToString("F1", BaseOption.DefaultCultureInfo);
            ...
            if (Outline != null) pairs[nameof(Outline)] = Outline.Value.ToString("F1", BaseOption.DefaultCultureInfo);
            if (Shadow != null) pairs[nameof(Shadow)] = Shadow.Value.ToString("F1", BaseOption.DefaultCultureInfo);
            ...
            if (AlphaLevel != null) pairs[nameof(AlphaLevel)] = AlphaLevel.Value.ToString(BaseOption.DefaultCultureInfo);
