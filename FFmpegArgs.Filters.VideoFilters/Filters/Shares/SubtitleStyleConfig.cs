namespace FFmpegArgs.Filters.VideoFilters
{
    ...
    public class SubtitleStyleConfig
    {
        ...
        public override string ToString()
        {
            ...
            if (Fontsize != null) pairs[nameof(Fontsize)] = Fontsize.Value.ToStringInv();
            ...
            if (Bold != null) pairs[nameof(Bold)] = (Bold.Value ? -1 : 0).ToStringInv();
            if (Italic != null) pairs[nameof(Italic)] = (Italic.Value ? -1 : 0).ToStringInv();
            if (Underline != null) pairs[nameof(Underline)] = (Underline.Value ? -1 : 0).ToStringInv();
            if (Strikeout != null) pairs[nameof(Strikeout)] = (Strikeout.Value ? -1 : 0).ToStringInv();
            if (ScaleX != null) pairs[nameof(ScaleX)] = ScaleX.Value.ToStringInv();
            if (ScaleY != null) pairs[nameof(ScaleY)] = ScaleY.Value.ToStringInv();
            if (Spacing != null) pairs[nameof(Spacing)] = Spacing.Value.ToStringInv("F1");
            if (Angle != null) pairs[nameof(Angle)] = Angle.Value.ToStringInv();
            if (BorderStyle != null) pairs[nameof(BorderStyle)] = ((int)BorderStyle.Value).ToStringInv();
            if (Outline != null) pairs[nameof(Outline)] = Outline.Value.ToStringInv("F1");
            if (Shadow != null) pairs[nameof(Shadow)] = Shadow.Value.ToStringInv("F1");
            if (Alignment != null) pairs[nameof(Alignment)] = ((int)Alignment.Value).ToStringInv();
            if (MarginL != null) pairs[nameof(MarginL)] = MarginL.Value.ToStringInv();
            if (MarginR != null) pairs[nameof(MarginR)] = MarginR.Value.ToStringInv();
            if (MarginV != null) pairs[nameof(MarginV)] = MarginV.Value.ToStringInv();
            if (AlphaLevel != null) pairs[nameof(AlphaLevel)] = AlphaLevel.Value.ToStringInv();
            if (Encoding.HasValue) pairs[nameof(Encoding)] = Encoding.Value.ToStringInv()!;
